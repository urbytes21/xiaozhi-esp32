...
private:
    ...
    void InitializeButtons() {
        ...
        // Set long press event for boot button (directly enter network configuration mode)
        boot_button_.OnLongPress([this]() {
            ...
            // Reset WiFi configuration to ensure entering network configuration mode
            EnterWifiConfigMode();
        });
...
public:
    ...
    virtual AudioCodec* GetAudioCodec() override {
        // Statically instantiate NoAudioCodecSimplex class
